...
The following code of conduct is modified from the [code of coduct of JGIBristol](https://raw.githubusercontent.com/JGIBristol/hackathon-template/main/code-of-conduct.md), available under MIT license:
...
* Harmful or prejudicial verbal or written comments or visual images related to
  ...
  characteristics, including those protected by law. Further, on scientific background, preferred coding tools, or academic seniority.
...
* Violating the rules and regulations online platforms (e.g. Zoom) or the Material Transfer Agreement. 

## Reporting incidents

If you believe someone is violating the code of conduct, please report this to
the [Katie Clepp](mailto:katie.clepp@northwestern.edu) or [Thomas Stoeger](mailto:thomas.stoeger@northwestern.edu) straight away, if you can. 
...
* Removal from mailing list or positions on working groups, and ability to participate in research publications resulting from the codathon
